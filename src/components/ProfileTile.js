        ...
        return (
            ...
            >
                ...
                <Card.Body style={bodyStyle}>
                    <Card.Title
                        className="profileTileLoginStyle"
                        style={tileLoginStyleLeft}
                    >
                        {groupData.login}
                    </Card.Title>
                    <Card.Title
                        className="profileTileNameStyle"
                        style={tileNameStyleLeft}
                    >
                        {groupData.name}
                    </Card.Title>
                    <img
                    ...
                    ></img>
                    <Card.Text
                        className="profileTileBioStyle"
                        style={tileBioStyleLeft}
                    >
                        {groupData.bio}
                    </Card.Text>
                    <div
                        className="profileTileLogosStyle"
                        style={tileLogosStyleLeft}
                    >
                        <Card.Link href={groupData.html_url} target="blank">
                            <RiGithubLine
                                className="profileTileIconStyle"
                                style={iconStyle}
                            />
                        </Card.Link>
