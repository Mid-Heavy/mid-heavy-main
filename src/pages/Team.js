...
export default function Team() {
  ...
  return (
    <Container style={{ position: "abosolute", overflow: "auto" }}>
      ...
      <ProfileTile imgPath={background[0]} isLeft={true} profile={members[2]} />
      <ProfileTile imgPath={background[1]} profile={members[1]} />
      <ProfileTile imgPath={background[2]} isLeft={true} profile={members[3]} />
      <ProfileTile imgPath={background[3]} profile={members[0]} />
    </Container>
  )
}
